            ...
            <div className="mb-6">
              ...
              <form className="flex gap-3 max-w-sm">
                <input
                  ...
                  className="flex-1 px-4 py-2 bg-white border border-gray-700 rounded-lg text-white placeholder-gray-700 focus:ring-2 focus:ring-[#DBDBDB] focus:border-transparent"
                />
                <button
                  type="submit"
