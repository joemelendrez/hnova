      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-[#1a1a1a] mb-4">Featured Articles</h2>
          ...
          <div className="text-center py-12">
            ...
            <Link href="/blog" className="inline-flex items-center mt-4 px-6 py-3 bg-[#fe0000] text-white font-semibold rounded-lg hover:bg-[#dc2626] transition-colors duration-200">
              View Blog
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  <div className="relative h-64 lg:h-auto">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="px-3 py-1 bg-[#DBDBDB] text-[#1a1a1a] text-sm font-medium rounded-full">Featured</span>
                    </div>
                  </div>
