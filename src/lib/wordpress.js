...
export async function getPostsByCategory(categoryName, first = 20) {
  const cacheKey = generateCacheKey('posts_by_category', { categoryName, first });
...
export async function preloadCriticalData() {
  ...
  try {
    ...
    const result = {
      posts: posts.status === 'fulfilled' ? posts.value : { edges: [], pageInfo: {} },
  ...
  const fallbackPosts = [
    {
      node: {
        ...
        featuredImage: {
          node: {
            sourceUrl: 'https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?w=600&h=400&fit=crop',
            altText: 'Person writing in journal',
          },
        },
        acfBlogFields: { readTime: '5 min read', featuredPost: true, customExcerpt: '' },
    ...
    },
    {
      node: {
        ...
        featuredImage: {
          node: {
            sourceUrl: 'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=600&h=400&fit=crop',
            altText: 'Smartphone and laptop',
          },
        },
        acfBlogFields: { readTime: '8 min read', featuredPost: false, customExcerpt: '' },
        content: '<p>This is fallback content for development. Connect to WordPress to see real content.</p>',
      },
    },
    {
      node: {
        ...
        acfBlogFields: { readTime: '6 min read', featuredPost: false, customExcerpt: '' },
        content: '<p>This is fallback content for development. Connect to WordPress to see real content.</p>',
      },
    },
    {
      node: {
        ...
        featuredImage: {
          node: {
            sourceUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&h=400&fit=crop',
            altText: 'Brain illustration',
          },
        },
        acfBlogFields: { readTime: '7 min read', featuredPost: false, customExcerpt: '' },
        content: '<p>This is fallback content for development. Connect to WordPress to see real content.</p>',
      },
    },
    {
      node: {
        ...
        excerpt: 'Smart sleep isn\'t about sleeping longer; it\'s about optimizing sleep quality for peak productivity.',
        date: '2024-12-05T00:00:00',
        categories: { edges: [{ node: { name: 'Productivity', slug: 'productivity' } }] },
        featuredImage: {
          node: {
            sourceUrl: 'https://images.unsplash.com/photo-1541781774459-bb2af2f05b55?w=600&h=400&fit=crop',
            altText: 'Person sleeping peacefully',
          },
        },
        acfBlogFields: { readTime: '5 min read', featuredPost: false, customExcerpt: '' },
        content: '<p>This is fallback content for development. Connect to WordPress to see real content.</p>',
      },
    },
  ];
